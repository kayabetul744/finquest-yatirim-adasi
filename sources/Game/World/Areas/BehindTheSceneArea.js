...
export class BehindTheSceneArea extends Area
{
    ...
    setInteractivePoint()
    {
        // The "Behind the scene" menu tab was removed, so there's no menu left to open/close.
        const menuItem = this.game.menu.items.get('behindTheScene')
