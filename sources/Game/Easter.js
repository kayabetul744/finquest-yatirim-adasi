    ...
    setMenu()
    {
        ...
        this.menu.updateEggs = (eggsData = null) =>
        {
            ...
            else
            {
                    ...
                    if(typeof egg === 'undefined')
                    {
                        const html = /* html */`
                            <div class="top">
                                ...
                                <div class="uses">Kullanıldı <span class="js-uses-current current"></span>/<span class="js-uses-total total"></span></div>
                            </div>
                            <div class="bar">
                ...
                //         <div class="uses">Kullanıldı <span class="current">X</span>/<span class="total">X</span></div>
                //     </div>
                //     <div class="bar">
                //         <div class="fill"></div>
                //     </div>
